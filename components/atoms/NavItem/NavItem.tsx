...
export const NavItem = ({ text, path, index, isActive }: Props) => {
  const buildItemClassName = () => {
    const basicStyle =
      "relative nav-text w-fit  hover:after:content-[''] hover:after:h-[3px] hover:after:bg-white hover:after:w-[100%] hover:after:absolute hover:after:bottom-0 cursor-pointer"
