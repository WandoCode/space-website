...
export default function Home() {
  return (
    <section className="min-h-[100dvh] flex flex-col md:bg-hero-bg-desktop bg-no-repeat bg-center bg-cover sm:bg-hero-bg-tablet bg-hero-bg-mobile">
      <LayoutPage mainClassName="flex-grow flex flex-col">
