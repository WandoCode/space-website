...
export default function Home() {
  return (
    <div className="min-h-[100dvh] flex flex-col md:bg-hero-bg-desktop bg-no-repeat bg-center bg-cover sm:bg-hero-bg-tablet bg-hero-bg-mobile">
      <LayoutPage>
        <section className="flex flex-col items-center gap-[81px] sm:gap-[156px] md:w-[80%] md:max-w-[1200px] md:mx-auto md:flex-row  md:justify-between md:gap-0 md:items-end">
