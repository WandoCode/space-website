  ...
  return (
    <div className="relative min-h-[100dvh] flex flex-col bg-crew-bg-mobile md:bg-crew-bg-desktop bg-no-repeat bg-center bg-cover  sm:bg-crew-bg-tablet isolate">
      ...
      <LayoutPage mainClassName="flex-grow sm:flex sm:flex-col ">
        <section className="flex flex-col gap-8 px-6 pb-[58px] pt-7 sm:px-[39px] sm:pt-10 sm:pb-0 sm:flex-grow sm:justify-between md:mx-[125px]  md:gap-[100px] md:pt-0">
          <h1 className="h5 sm:self-start sm:mb-[60px] md:mb-[97px] ">
            <span className="font-bold text-white/25 pr-2">02 </span> Meet your
            crew
          </h1>
          <div className="relative h-[222px] border-b-[1px] border-solid border-gray-700 sm:border-none sm:order-1 sm:flex-grow">
            <Image
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="p sm:max-w-[650px] sm:mb-8">{currPerson.bio}</p>
          </div>
        </section>
      </LayoutPage>
    </div>
